...
{
    public partial class CustAccountData : Form
    {
        ...
        void Bindcombo()
        {
            Cmb_Search.DataSource = RetriveData.ExcuteQuery("Sp_Customers_SelectAll", CommandType.StoredProcedure);
        ...
        private void Btn_Search_Click(object sender, EventArgs e)
        {
            if (Cmb_Search.Text != "")
            {
                ...
                Dt = RetriveData.ExcuteQuery("Sp_Customers_SelectByID", CommandType.StoredProcedure, new Pararmter("@Cust_ID", SqlDbType.Int, int.Parse(Cmb_Search.SelectedValue.ToString())));
                Lbl_Find.Text = Dt.Rows[0]["Cust_ID"].ToString();
        ...
        private void Btn_Save_Click(object sender, EventArgs e)
        {
            ...
            {
                RetriveData.ExcuteNonQuery("Sp_Cust_Account_Insert",
                    new Pararmter("@Cust_ID", SqlDbType.Int, int.Parse(Cmb_Search.SelectedValue.ToString())),
