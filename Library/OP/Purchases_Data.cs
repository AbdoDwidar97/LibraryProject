...
namespace Library.OP
{
    public partial class Purchases_Data : Form
    {
        ...
        {
            Cmb_VendorName.DataSource = RetriveData.ExcuteQuery("Sp_Vendors_SelectAll", CommandType.StoredProcedure);
            Cmb_VendorName.DisplayMember = "ven_Name";
            Cmb_VendorName.ValueMember = "Ven_ID";
            Cmb_VendorName.Text = "";
        ...
        private void Btn_Save_Click(object sender, EventArgs e)
        {
            ...
            ccon.Comm.CommandText = "Sp_Main_PurchasesInsert";
            ccon.Comm.Parameters.Clear();

            ccon.Comm.Parameters.AddWithValue("@Ven_ID",int.Parse(Cmb_VendorName.SelectedValue.ToString()));
            ccon.Comm.Parameters.AddWithValue("@Purchase_Date",DateTime.Parse(DTP_Purchase.Text));
            ...
            ccon.Comm.Parameters.AddWithValue("@Purchases_Notes", Txt_Notes.Text);
            ...
            ccon.Comm.Parameters.AddWithValue("@PurchasDataTable", ddt);
